        ...
        <div className="hero">
          <div className="hero__content">
            ...
            <div className="hero__content-text">
              ...
              <p className="large secondary-text">Currently working as Front-end software developer at <a className="globant" href="http://www.globant.com" rel="noopener" target="_blank">Globant</a> in Santiago, Chile.</p>
              <p className="large secondary-text">I'm also an amateur photographer, a community builder enthusiast<br />and I volunteer for non-profit organizations.</p>
            </div>
