...
export default () =>
  <section className="section">
    ...
    <div className="section__content">
      ...
      <p>Would you like to know more? You can contact me and ask what you need to know. <strong>You can also <a className="underline-link" href="https://www.paypal.me/ivanolivaresrojas/4" rel="noopener" title="Buy me a coffee!">buy me coffee</a></strong> which is welcome :)</p>
