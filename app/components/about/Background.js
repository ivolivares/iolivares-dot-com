...
export default () =>
  <section className="section">
    ...
    <div className="section__content">
      <p>I have more than { calculateYears(wesDate) } years of work experience working in different industries such as digital marketing, e-commerce, streaming (video and audio) for high concurrency users and recently the airline industry.</p>
