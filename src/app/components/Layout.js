...
export default ({ children, title = 'Iván Olivares Rojas | Front-end software engineer' }) => (
  <div>
    <Head>
      <meta charset='utf-8' />
      <meta http-equiv='X-UA-Compatible' content='IE=edge, chrome=1' />
      <title>{title}</title>
      <meta name='description' content='Front-end software engineer focused on building beautiful interfaces and experiences.' />
